...
const Signin = () => {
  const signInLink = `${process.env.NEXT_PUBLIC_APP_SIGNIN}`; // Change this to your actual sign-in page route, e.g., "/auth/signin"
  ...
  return (
    <div className="absolute inset-y-0 right-0 flex items-center sm:static sm:inset-auto sm:pr-0">
      <div className="hidden lg:block">
        ...
        <button
      onClick={() => router.push(`${process.env.NEXT_PUBLIC_APP_SIGNIN}`)}
      className="text-lg text-blue font-medium"
    >
      Sign In
    </button>
